...
def all_keys(recycle)
  recycle.each_key do |key|
    puts key
  end
end
...
def all_data(recycle)
  recycle.each_value do |value|
    puts value
  end
end
...
def key_and_data(recycle)
  recycle.each do |key, value|
